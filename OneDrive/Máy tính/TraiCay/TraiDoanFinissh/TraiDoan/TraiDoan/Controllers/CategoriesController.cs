...
{
    public class CategoriesController : CheckAdmin
    {
        ...
        public ActionResult Index(string sortOrder, string currentFilter, string searchString, int? page)
        {
            ...
            {
                cate = cate.Where(s => s.NameCategory.Contains(searchString));
            }
            switch (sortOrder)
            {
                case "name_desc":
                    cate = cate.OrderByDescending(s => s.NameCategory);
                    break;            
                default:  // Name ascending 
                    cate = cate.OrderBy(s => s.NameCategory);
                    break;
            }
